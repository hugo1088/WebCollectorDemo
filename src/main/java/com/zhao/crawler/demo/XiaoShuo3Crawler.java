 ...
 * @author hu
 */
public class XiaoShuo3Crawler extends BreadthCrawler {
    /**
     ...
     */
    public XiaoShuo3Crawler(String crawlPath, boolean autoParse) {
        super(crawlPath, autoParse);
        /*start page*/
        //圣虚
        //this.addSeed("http://www.biqiuge.com/book/4772/6919199.html");
        //this.addRegex("http://www.biqiuge.com/book/4772/.*");
        //龙王传说
        this.addSeed("https://www.biqugeg.com/0_278/");
        this.addRegex("https://www.biqugeg.com/0_278/.*");
        setThreads(50);
        getConf().setTopN(100);
//        setResumable(true);
    }
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        if (Pattern.matches("https://www.biqugeg.com/0_278/.+html", url)) {
    ...
    public static void main(String[] args) throws Exception {
        XiaoShuo3Crawler crawler = new XiaoShuo3Crawler("crawl", true);
        crawler.start(4);
    }
